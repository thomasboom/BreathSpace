...
class SettingsScreen extends StatefulWidget {
  final bool
  fromExercise; // Flag to indicate if the settings were opened from the exercise screen
...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          if (details.delta.dx > 0) {
            ...
            if (details.delta.dx > 5) {
              ...
              if (widget.fromExercise) {
                Navigator.of(
                  context,
                ).pop(); // Just pop settings screen, let exercise screen handle the rest
              } else {
                Navigator.of(
                  context,
                ).pop(); // Normal navigation for other cases
              }
            }
          }
        },
  ...
  Widget _buildSettingsCard({required String title, required Widget trailing}) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
